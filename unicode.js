...
let firstCodePoint = inputString1.charCodeAt(0); // Fixed: Use inputString1 instead of word
let thirdCodePoint = inputString1.charCodeAt(2); // Fixed: Use inputString1 instead of word
...
let swappedString = inputString2[inputString2.length - 1] + 
                    inputString2.slice(1, -1) + 
                    inputString2[0]; // Simplified: Use inputString2 directly
